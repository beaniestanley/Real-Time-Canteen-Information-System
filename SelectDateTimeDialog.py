...
class Ui_SelectDateTime(object):
    def setupUi(self, SelectDateTime):
        ...
        SelectDateTime.setWindowIcon(QtGui.QIcon("window_icon.png"))
...
"alternate-background-color: rgb(164, 255, 237);"
        ...
        self.timeEdit.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(datetime.now().year, datetime.now().month,
