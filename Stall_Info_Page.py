...
# Page UI designed using PyQt5 Designer and coded by Shah, parts done by others are stated specifically and boxed up
...
class Ui_Stall_Info_Window(object):
    def setupUi(self, Stall_Info_Window, stall, mainWindowController):
        ...
        # using the hour to set random waiting time from 2 to 5 mins if peakhour and 1 to 3 min if non peak hour
        ...
        Stall_Info_Window.setWindowIcon(QtGui.QIcon("window_icon.png"))
        ...
        # button for calculation of waiting time
        ...
        # label for stall operating hours
        ...
        # title of the table "Menu" and its font styling
        font = QtGui.QFont()
        ...
        # title of the table "Price" and its font styling
        ...
        # generation of the menu list space
        ...
        # generation of the price list space
        ...
        # the line separating the menu grid and the stall grid and its styling
        ...
        # grid layout for calculating time
        ...
        # label showing "calculated wait time"
        ...
        # label for calculated waiting time
    ...
    def retranslateUi(self, Stall_Info_Window):
        ...
        self.label_selectedDateTime.setText(
            _translate(
                "Stall_Info_Window",
                "Selected Date and Time: " + self.selectedDatetime.strftime("%A, %d/%m/%Y, %H:%M")))
        ############################################################################################################

        self.label_calcWaitTime.setText("Estimated Waiting Time: ")

        # hide the label and calculated result as user has not key in anything
        self.label_calcWaitTime.hide()
        self.label_resultWaitTime.hide()

        # initialise the names for respective labels
        Stall_Info_Window.setWindowTitle(_translate("Stall_Info_Window", self.stall.name))
